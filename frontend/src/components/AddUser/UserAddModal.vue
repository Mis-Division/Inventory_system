...
function defaultModules() {
  return [
    ...
    { module_name: "Material Credit Ticket", parent_module: "Inventory", can_view: false, can_add: false, can_edit: false, can_delete: false },
    ...
    { module_name: "MCRT Reports", parent_module: "Reports", can_view: false, can_add: false, can_edit: false, can_delete: false },
