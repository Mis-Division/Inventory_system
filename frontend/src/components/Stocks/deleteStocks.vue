        ...
        <div class="modal-dialog modal-m modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header bg-danger text-white">
                    ...
                    <button type="button" class=" btn btn-close btn-close-whte" @click="closeModal"></button>
                </div>
                    ...
                    <form class="row">
                        <div class="col-12 text-center">
                            ...
                            <div class="form-control bg-light text-center fw-semibold border-0 shadow-sm">
                                {{ localStock.item_code }} | {{ localStock.product_name }}
                            </div>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    ...
                    <button class="btn btn-danger" @click="deleteStocks">
...
const localStock = reactive({ ...prop.stock });
const showSuccess = ref(false);

async function deleteStocks() {
    try {
        appStore.showLoading();
        await api.delete(`/stocks/deleteStocks/${localStock.id}`);
